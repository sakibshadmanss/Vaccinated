...
<body>
	...
	<div class="container">
		...
		<div class="form-box">
			...
			<legend class="mt-5 text-center text-light" style="font-size:2.5rem; font-weight:bolder;">HOSPITAL LOGIN</legend>
		...
		<div class="input-group mb-3">
          <input type="text" class="form-control" name="hospitalUsername" placeholder="Hospital Username">
        ...
        <div class="row">
		  ...
		  <a href="hospitalForgetpass.php" class="text-light">Forgot Password?</a>
          <!-- /.col -->
        </div>
		</div>
...
.input.form-control{
	...
	<?php 
		...
		if(isset($_POST['Login'])){
			...
			$login_qry = "SELECT * FROM hospital WHERE hospitalUsername = '$hospitalUsername' AND password = '$password'";

			
			$RSL = mysqli_query($conn, $login_qry);
			
			if($Dat = mysqli_fetch_assoc($RSL)){
                $_SESSION['GenLuserdata'] = $Dat['hospitalUsername'];
				$_SESSION['hospitalName'] = $Dat['hospitalName'];
				$_SESSION["location_id"] = $Dat["id"];
