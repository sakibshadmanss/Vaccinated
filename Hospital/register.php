...
<body>
	...
	<div class="container">
		...
		<form method="post" class="mx-auto" style="width: 50%;">
			...
			<div class="mb-3">
				...
				<input type="email" class="form-control" name="Email" pleaceholder="Please Enter Hospital Email" required>
			</div>
			<div class="mb-3">
	...
	<?php 
		...
		if(isset($_POST['Register'])){
			...
			$Reg_qry = "INSERT INTO hospital(hospitalName, hospitalUsername, Email, password) VALUES ('$hospitalName', '$hospitalUsername', '$Email', '$password')"; 
			
			if(mysqli_query($conn, $Reg_qry)){
				echo ("<script LANGUAGE='JavaScript'>window.alert('Hospital Register Successfull !!!');window.location.href='index.php';</script>");
			}else{
				failed();
			}
