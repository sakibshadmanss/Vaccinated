...
if (session_status() == PHP_SESSION_NONE) {
    ...
    if(isset($_SESSION['userdata'])){
        ...
        <style type="text/css">
           ...
           /* background: linear-gradient(45deg, #9103c5, #13b44c); */
...
<div>
    <div class="col-md-6 d-inline">
        <h2 class="mt-5 p-3 d-inline-block text-light">Vaccination Record</h2>
    </div>
    <div class="col-md-6 d-inline-block">
        <a href="Dashboard.php" class="text-decoration-none btn btn-outline-light" > Dashboard </a>
        <a href="Logout.php" class="text-decoration-none btn btn-outline-light"> Logout </a>
    </div>
</div>
