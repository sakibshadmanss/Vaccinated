	...
	<div class="container">
		...
		<form method="post" class="mx-auto" style="width: 50%;">
			...
			<div class="mb-3">
				...
				<small style="font-size: 12px;">[This is the address from where you want to receive vaccine. Mention the City/Village correctly. Mention your Ward number too. ex- Ward: 33, Townhall, Mohammadpur, Dhaka]</small>
			</div>
			<div class="mb-3">
				...
				<small style="font-size: 12px;">[Please select which vaccine you want to have. You can't choose the name of vaccine you'll get the available one, just select the purpose or antibody you want.]</small>
			</div>
