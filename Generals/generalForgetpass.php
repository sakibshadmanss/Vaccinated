...
if(isset($_REQUEST['pwdrst']))
{
  ...
  $check_Email = mysqli_query($conn,"select Email from general_user where Email='$Email'");
  ...
  if($res>0)
  {
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/vaccinated/Generals/passwordresetgeneral.php?secret='.base64_encode($Email).'">Reset Password</a></button></p>
     <br>
