...
<head>
    ...
    width: 46%;
		...
		/* .btn-ad{
		border: 2px solid rgb(190, 114, 0);
  ...
  <div class="card-body">
	<div>
		...
		<form class="text-center d-block" method="post">
			...
			<button class="btn btn-success p-3 me-3 btn-us" name="General"> LOGIN AS CHILD'S PARENT </button>
			<button class="btn btn-success p-3 me-3  btn-hos" name="Hospital"> LOGIN AS HOSPITAL </button>
		</form>
		...
		<div class="row">
			...
			<ul>
				<li>১। সময়সূচি অনুযায়ী সবগুলো টিকা নিলে আপনার শিশু উপরে বর্ণিত মারাত্মক সংক্রামক রোগসমুহ হতে রক্ষা পাবে ।</li>
				<li>২। সময়সূচি অনুযায়ী টিকা না নিলে আপনার শিশুর মারাত্মক সংক্রামক রোগসমুহের বিরুদ্ধে রোগ প্রতিরোধ ক্ষমতা তৈরি নাও হতে পারে ।</li>
