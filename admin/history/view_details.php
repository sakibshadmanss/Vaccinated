<?php 
 ...
 $individual_qry = $conn->query("SELECT *,concat(firstname,' ', middlename, ' ', lastname ) as name FROM individual_list where id ='{$individual_id}'");
 ...
 $location_qry = $conn->query("SELECT * FROM hospital WHERE id = '{$location_id}'");
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <dl>
                        ...
                        <dd class="pl-4"><?php echo isset($result_location['hospitalName']) ? $result_location['hospitalName'] : '' ?></dd>
